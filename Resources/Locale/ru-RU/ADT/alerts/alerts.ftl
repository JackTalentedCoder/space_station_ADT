...
alerts-infection-name = [color=#0b9630]Инфекция[/color]
alerts-infection-desc = [color=#0c690f]Вы чувствуете как ваше тело ослабевает. Нужно обеззаразить раны, иначе можно умереть.[/color]
